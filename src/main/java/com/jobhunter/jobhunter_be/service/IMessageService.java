...
public interface IMessageService {
    List<MessageResponse> getMessagesByConversation(Long conversationId, int page, int size, String requesterEmail) throws NotFoundException;
    Message saveMessage(Long conversationId, String senderEmail, String content, String fileUrl) throws NotFoundException;
